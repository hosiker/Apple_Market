...
import com.companyname.apple_market.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.statusimage2.setOnClickListener {
            notification()
        }
    ...
    override fun onBackPressed() {
        ...
        alertDialogBuilder.setPositiveButton("확인") { dialog, id -> finish() }
        alertDialogBuilder.setNegativeButton("취소") { dialog, id -> dialog.cancel() }
